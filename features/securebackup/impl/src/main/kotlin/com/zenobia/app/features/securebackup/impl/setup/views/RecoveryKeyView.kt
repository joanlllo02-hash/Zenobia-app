...
package com.zenobia.app.features.securebackup.impl.setup.views
...
import com.zenobia.app.features.securebackup.impl.tools.RecoveryKeyVisualTransformation
import com.zenobia.app.libraries.designsystem.modifiers.clickableIfNotNull
...
private fun RecoveryKeyWithCopy(
    ...
    Row(
        ...
        Text(
            ...
            style = ZenobiaTheme.typography.fontBodyLgRegular.copy(fontFamily = FontFamily.Monospace),
