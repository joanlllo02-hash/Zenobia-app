...
package com.zenobia.app.features.rageshake.impl.bugreport
...
import com.zenobia.app.features.rageshake.impl.R
...
import com.zenobia.app.libraries.designsystem.components.preferences.PreferenceDivider
import com.zenobia.app.libraries.designsystem.components.preferences.PreferencePage
import com.zenobia.app.libraries.designsystem.components.preferences.PreferenceRow
...
@Composable
internal fun BugReportViewDayPreview(@PreviewParameter(BugReportStateProvider::class) state: BugReportState) = ZenobiaPreview {
    BugReportView(
        state = state,
        onSuccess = {},
        onBackClick = {},
...
@Composable
internal fun BugReportViewNightPreview(@PreviewParameter(BugReportStateProvider::class) state: BugReportState) = ZenobiaPreview {
    BugReportView(
        state = state,
        onSuccess = {},
        onBackClick = {},
