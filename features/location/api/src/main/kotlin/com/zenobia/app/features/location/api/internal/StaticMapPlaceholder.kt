...
package com.zenobia.app.features.location.api.internal
...
import com.zenobia.app.features.location.api.R
...
@PreviewsDayNight
@Composable
internal fun StaticMapPlaceholderPreview() = ZenobiaPreview {
    Column(
