...
import com.zenobia.app.features.location.impl.common.ui.LocationPinMarkers
import com.zenobia.app.features.location.impl.common.ui.LocationShareRow
...
@PreviewsDayNight
@Composable
internal fun ShowLocationViewPreview(@PreviewParameter(ShowLocationStateProvider::class) state: ShowLocationState) = ZenobiaPreview {
    ShowLocationView(
        state = state,
        onBackClick = {},
    )
