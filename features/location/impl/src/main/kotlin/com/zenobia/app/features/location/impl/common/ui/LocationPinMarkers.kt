...
import com.zenobia.app.libraries.designsystem.components.rememberLocationPinBitmap
...
fun LocationPinMarkers(
    ...
    val clusterColor = ZenobiaTheme.colors.bgAccentRest
    val clusterStrokeColor = ZenobiaTheme.colors.iconOnSolidPrimary
    val clusterTextColor = ZenobiaTheme.colors.textOnSolidPrimary
    val clusterTextStyle = ZenobiaTheme.typography.fontBodyMdMedium
