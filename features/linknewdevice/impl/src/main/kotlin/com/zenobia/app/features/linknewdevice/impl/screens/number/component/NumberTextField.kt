...
package com.zenobia.app.features.linknewdevice.impl.screens.number.component
...
import com.zenobia.app.features.linknewdevice.impl.screens.number.model.Digit
...
private fun DigitView(
    ...
    val appearanceModifier = when (digit) {
        ...
        is Digit.Filled -> {
            Modifier.background(ZenobiaTheme.colors.bgActionSecondaryPressed, shape)
        }
    }
    Box(
        modifier = Modifier
    ...
    if (isCursorVisible) {
        Spacer(
            modifier = Modifier
                .size(2.dp, 24.dp)
                .offset(x = (-5).dp)
                .background(ZenobiaTheme.colors.textPrimary, RoundedCornerShape(1.dp))
        )
    }
}
