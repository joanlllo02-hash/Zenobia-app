...
import com.zenobia.app.libraries.designsystem.modifiers.cornerBorder
...
import com.zenobia.app.libraries.qrcode.QrCodeCameraView
...
@PreviewsDayNight
@Composable
internal fun ScanQrCodeViewPreview(@PreviewParameter(ScanQrCodeStateProvider::class) state: ScanQrCodeState) = ZenobiaPreview {
    ScanQrCodeView(
        state = state,
        onBackClick = {},
    )
