...
import com.zenobia.app.features.home.impl.components.RoomSummaryRow
...
@PreviewsDayNight
@Composable
internal fun RoomListSearchContentPreview(@PreviewParameter(RoomListSearchStateProvider::class) state: RoomListSearchState) = ZenobiaPreview {
    RoomListSearchContent(
        state = state,
