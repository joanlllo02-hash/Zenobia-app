...
import com.zenobia.app.features.home.impl.model.RoomListRoomSummaryProvider
...
import com.zenobia.app.libraries.designsystem.theme.roomListRoomMessage
import com.zenobia.app.libraries.designsystem.theme.roomListRoomMessageDate
import com.zenobia.app.libraries.designsystem.theme.roomListRoomName
...
import com.zenobia.app.libraries.matrix.ui.components.InviteSenderView
...
private fun NameAndTimestampRow(
    ...
    Row(
        ...
        Text(
            ...
            color = ZenobiaTheme.colors.roomListRoomName,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis
        )
        // Timestamp
        Text(
            ...
            color = if (isHighlighted) {
                ZenobiaTheme.colors.unreadIndicator
            } else {
                ZenobiaTheme.colors.roomListRoomMessageDate
            },
        )
    }
}
...
private fun InviteSubtitle(
    ...
    if (subtitle != null) {
        Text(
            ...
            overflow = TextOverflow.Ellipsis,
            style = ZenobiaTheme.typography.fontBodyMdRegular,
            color = ZenobiaTheme.colors.roomListRoomMessage,
        )
    }
}
...
private fun MessagePreviewAndIndicatorRow(
    ...
    Row(
        ...
        Row(
            ...
            val tint = if (room.isHighlighted) ZenobiaTheme.colors.unreadIndicator else ZenobiaTheme.colors.iconQuaternary
            if (room.hasRoomCall) {
                OnGoingCallIcon(
                    color = tint,
...
private fun NotificationOffIndicatorAtom() {
    Icon(
        ...
        tint = ZenobiaTheme.colors.iconQuaternary,
    )
}
...
private fun MentionIndicatorAtom() {
    Icon(
        ...
        tint = ZenobiaTheme.colors.unreadIndicator,
    )
}

@PreviewsDayNight
@Composable
internal fun RoomSummaryRowPreview(@PreviewParameter(RoomListRoomSummaryProvider::class) data: RoomListRoomSummary) = ZenobiaPreview {
    RoomSummaryRow(
        room = data,
