...
package com.zenobia.app.features.home.impl.spacefilters
...
@PreviewsDayNight
@Composable
internal fun SpaceFiltersViewPreview(@PreviewParameter(SpaceFiltersStateProvider::class) state: SpaceFiltersState) = ZenobiaPreview {
