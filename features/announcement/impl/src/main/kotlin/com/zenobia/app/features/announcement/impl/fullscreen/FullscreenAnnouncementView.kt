...
import com.zenobia.app.features.announcement.impl.AnnouncementStateProvider
...
private fun FullscreenAnnouncementContent(
    ...
    Column(
        ...
        InfoListOrganism(
            ...
            textStyle = ZenobiaTheme.typography.fontBodyLgMedium,
...
@PreviewsDayNight
@Composable
internal fun FullscreenAnnouncementViewPreview(@PreviewParameter(AnnouncementStateProvider::class) state: AnnouncementState) = ZenobiaPreview {
    FullscreenAnnouncementView(
        state = state,
    )
}
