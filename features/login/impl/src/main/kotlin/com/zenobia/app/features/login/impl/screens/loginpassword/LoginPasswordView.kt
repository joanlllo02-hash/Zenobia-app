...
import com.zenobia.app.features.login.impl.error.loginError
...
@PreviewsDayNight
@Composable
internal fun LoginPasswordViewPreview(@PreviewParameter(LoginPasswordStateProvider::class) state: LoginPasswordState) = ZenobiaPreview {
    LoginPasswordView(
        state = state,
        onBackClick = {},
    )
