...
import com.zenobia.app.libraries.designsystem.theme.pinnedMessageBannerBorder
import com.zenobia.app.libraries.designsystem.theme.pinnedMessageBannerIndicator
...
private fun PinnedMessagesBannerRow(
    ...
    val borderColor = ZenobiaTheme.colors.pinnedMessageBannerBorder
    Row(
        modifier = modifier
                ...
                modifier = Modifier
                    ...
                    .background(
                        color = if (index == activeIndex) {
                            ...
                            ZenobiaTheme.colors.pinnedMessageBannerIndicator
                        } else {
                            Color.Transparent
                        }
                    ),
...
@PreviewsDayNight
@Composable
internal fun PinnedMessagesBannerViewPreview(@PreviewParameter(PinnedMessagesBannerStateProvider::class) state: PinnedMessagesBannerState) = ZenobiaPreview {
