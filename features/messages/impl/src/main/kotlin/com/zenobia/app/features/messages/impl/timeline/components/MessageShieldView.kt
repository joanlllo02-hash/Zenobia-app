...
import com.zenobia.app.libraries.matrix.api.timeline.item.event.isCritical
...
internal fun MessageShieldData.toIconColor(): Color {
    return when (isCritical) {
        true -> ZenobiaTheme.colors.iconCriticalPrimary
        false -> ZenobiaTheme.colors.iconSecondary
    }
}
...
private fun MessageShieldData.toTextColor(): Color {
    return when (isCritical) {
        true -> ZenobiaTheme.colors.textCriticalPrimary
        false -> ZenobiaTheme.colors.textSecondary
    }
}
