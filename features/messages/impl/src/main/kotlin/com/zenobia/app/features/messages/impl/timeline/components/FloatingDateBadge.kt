...
import com.zenobia.app.libraries.designsystem.theme.floatingDateBadgeBackground
...
internal fun FloatingDateBadge(
    ...
    Surface(
        ...
        color = ZenobiaTheme.colors.floatingDateBadgeBackground,
...
@PreviewsDayNight
@Composable
internal fun FloatingDateBadgePreview() = ZenobiaPreview {
