...
import com.zenobia.app.features.messages.impl.timeline.model.bubble.BubbleStateProvider
import com.zenobia.app.libraries.core.extensions.to01
...
import com.zenobia.app.libraries.ui.utils.graphics.drawInLayer
...
object MessageEventBubbleDefaults {
    ...
    fun backgroundBubbleColor(isMine: Boolean): Color {
        return if (isMine) {
            ZenobiaTheme.colors.messageFromMeBackground
        } else {
            ZenobiaTheme.colors.messageFromOtherBackground
        }
    }
...
@PreviewsDayNight
@Composable
internal fun MessageEventBubblePreview(@PreviewParameter(BubbleStateProvider::class) state: BubbleState) = ZenobiaPreview {
