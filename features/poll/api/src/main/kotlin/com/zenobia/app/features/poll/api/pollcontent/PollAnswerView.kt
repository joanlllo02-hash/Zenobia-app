...
import com.zenobia.app.features.poll.api.R
        ...
        Column {
            Row {
                Text(
                    ...
                    style = if (answerItem.isWinner) ZenobiaTheme.typography.fontBodyLgMedium else ZenobiaTheme.typography.fontBodyLgRegular,
                )
                if (answerItem.showVotes) {
                    Row(
                        ...
                        if (answerItem.isWinner) {
                            Icon(
                                ...
                                contentDescription = null,
                                tint = ZenobiaTheme.colors.iconAccentTertiary,
                            )
            ...
            LinearProgressIndicator(
                ...
                color = if (answerItem.isWinner) ZenobiaTheme.colors.textSuccessPrimary else answerItem.isEnabled.toEnabledColor(),
                progress = {
                    when {
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewDisclosedNotSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewDisclosedSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewUndisclosedNotSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewUndisclosedSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewEndedWinnerNotSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewEndedWinnerSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
...
@PreviewsDayNight
@Composable
internal fun PollAnswerViewEndedSelectedPreview() = ZenobiaPreview {
    PollAnswerView(
