...
import com.zenobia.app.libraries.designsystem.components.dialogs.SingleSelectionDialog
...
@PreviewsDayNight
@Composable
internal fun NotificationSettingsViewPreview(@PreviewParameter(NotificationSettingsStateProvider::class) state: NotificationSettingsState) = ZenobiaPreview {
