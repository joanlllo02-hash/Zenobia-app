...
package com.zenobia.app.features.preferences.impl.advanced
...
import com.zenobia.app.libraries.designsystem.preview.ZenobiaPreviewBlack
...
import com.zenobia.app.libraries.designsystem.text.stringWithLink
...
import com.zenobia.app.libraries.designsystem.theme.components.ListSupportingTextDefaults
    ...
    PreferenceCategory(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text("${start}m", color = ZenobiaTheme.colors.textSecondary, style = ZenobiaTheme.typography.fontBodyMdRegular)
                Slider(
                    modifier = Modifier
                        .weight(1f)
                    ...
                    colors = SliderDefaults.colors(
                        thumbColor = ZenobiaTheme.colors.iconAccentPrimary,
                        activeTrackColor = ZenobiaTheme.colors.iconAccentPrimary,
                        inactiveTrackColor = ZenobiaTheme.colors.bgBadgeAccent,
                        inactiveTickColor = ZenobiaTheme.colors.iconAccentPrimary,
                    )
                )
                Text("${end}m", color = ZenobiaTheme.colors.textSecondary, style = ZenobiaTheme.typography.fontBodyMdRegular)
            }
        }
...
internal fun AdvancedSettingsViewLightPreview(@PreviewParameter(AdvancedSettingsStateProvider::class) state: AdvancedSettingsState) =
    ZenobiaPreviewLight { ContentToPreview(state) }
...
internal fun AdvancedSettingsViewDarkPreview(@PreviewParameter(AdvancedSettingsStateProvider::class) state: AdvancedSettingsState) =
    ZenobiaPreviewDark { ContentToPreview(state) }
...
internal fun AdvancedSettingsViewBlackPreview(@PreviewParameter(AdvancedSettingsStateProvider::class) state: AdvancedSettingsState) =
    ZenobiaPreviewBlack { ContentToPreview(state) }
