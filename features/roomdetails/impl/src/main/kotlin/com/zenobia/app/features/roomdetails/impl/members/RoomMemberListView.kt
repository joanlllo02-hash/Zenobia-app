...
import com.zenobia.app.libraries.designsystem.theme.components.SearchField
...
@PreviewsDayNight
@Composable
internal fun RoomMemberListViewPreview(@PreviewParameter(RoomMemberListStateProvider::class) state: RoomMemberListState) = ZenobiaPreview {
    RoomMemberListView(
        state = state,
