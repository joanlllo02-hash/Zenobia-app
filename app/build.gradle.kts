...
plugins {
    id("com.zenobia.android-compose-application")
...
android {
    ...
    buildTypes {
        val oAuthRedirectSchemeBase = BuildTimeConfig.METADATA_HOST_REVERSED ?: "com.zenobia.app"
        getByName("debug") {
...
licensee {
    ...
    ignoreDependencies(groupId = "com.zenobia.app")
}
