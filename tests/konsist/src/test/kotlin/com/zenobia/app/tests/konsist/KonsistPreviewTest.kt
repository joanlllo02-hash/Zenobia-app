        ...
        Konsist
            ...
            .assertTrue(
                additionalMessage = "Functions with 'A11yPreview' suffix should have '@Preview' annotation and not '@PreviewsDayNight'," +
                    " should contain 'ZenobiaPreview' composable," +
                ...
                (it.text.contains("$testedView(") || it.text.contains("ContentToPreview(")) &&
                    ...
                    it.text.contains("ZenobiaPreview") &&
                    it.hasInternalModifier
            }
    }

    @Test
    fun `Functions with '@PreviewsDayNight' annotation should contain 'ZenobiaPreview' composable`() {
        Konsist
            .scopeFromProject()
            .functions()
            .withAllAnnotationsOf(PreviewsDayNight::class)
