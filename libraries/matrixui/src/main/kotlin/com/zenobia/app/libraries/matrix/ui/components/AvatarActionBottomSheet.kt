            ...
            ListItem(
                ...
                headlineContent = {
                    Text(
                        ...
                        color = if (action.destructive) ZenobiaTheme.colors.textCriticalPrimary else ZenobiaTheme.colors.textPrimary,
                    )
                },
...
@PreviewsDayNight
@Composable
internal fun AvatarActionBottomSheetPreview() = ZenobiaPreview {
