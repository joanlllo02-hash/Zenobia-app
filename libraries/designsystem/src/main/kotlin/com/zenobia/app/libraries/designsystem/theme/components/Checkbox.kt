...
private fun compoundCheckBoxColors(): CheckboxColors {
    return CheckboxDefaults.colors(
        checkedColor = ZenobiaTheme.colors.bgAccentRest,
        uncheckedColor = ZenobiaTheme.colors.borderInteractivePrimary,
        checkmarkColor = ZenobiaTheme.materialColors.onPrimary,
        disabledUncheckedColor = ZenobiaTheme.colors.borderDisabled,
        disabledCheckedColor = ZenobiaTheme.colors.iconDisabled,
        disabledIndeterminateColor = ZenobiaTheme.colors.iconDisabled,
    )
}
...
private fun compoundErrorCheckBoxColors(): CheckboxColors {
    return CheckboxDefaults.colors(
        checkedColor = ZenobiaTheme.materialColors.error,
        uncheckedColor = ZenobiaTheme.materialColors.error,
        checkmarkColor = ZenobiaTheme.materialColors.onPrimary,
        disabledUncheckedColor = ZenobiaTheme.colors.borderDisabled,
        disabledCheckedColor = ZenobiaTheme.colors.iconDisabled,
        disabledIndeterminateColor = ZenobiaTheme.colors.iconDisabled,
...
@Composable
internal fun CheckboxesPreview() = ZenobiaThemedPreview(vertical = false) {
    Column {
        // Unchecked
