...
import com.zenobia.app.libraries.designsystem.components.tooltip.PlainTooltip
import com.zenobia.app.libraries.designsystem.components.tooltip.TooltipBox
...
fun HorizontalFloatingToolbar(
    ...
    colors: FloatingToolbarColors = FloatingToolbarDefaults.standardFloatingToolbarColors().copy(
        toolbarContainerColor = ZenobiaTheme.colors.bgSubtleSecondary,
    ),
    ...
    TooltipBox(
        ...
        val colors = if (isSelected) {
            IconButtonDefaults.filledIconButtonColors().copy(
                containerColor = ZenobiaTheme.colors.bgCanvasDefault,
                contentColor = ZenobiaTheme.colors.iconPrimary,
            )
        } else {
            IconButtonDefaults.filledIconButtonColors().copy(
...
@PreviewsDayNight
@Composable
internal fun HorizontalFloatingToolbarPreview() = ZenobiaPreview {
    ContentToPreview(
...
@PreviewsDayNight
@Composable
internal fun HorizontalFloatingToolbarNoFabPreview() = ZenobiaPreview {
    ContentToPreview(
