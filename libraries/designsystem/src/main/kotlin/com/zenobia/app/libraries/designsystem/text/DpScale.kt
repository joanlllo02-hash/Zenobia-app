...
package com.zenobia.app.libraries.designsystem.text
...
import com.zenobia.app.libraries.designsystem.preview.WithFontScale
    ...
    ZenobiaPreviewLight {
        ...
        Column(
            ...
            Text(
                ...
                style = ZenobiaTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.toSp())
            )
            Text(
                text = "Text with the same size (applyScaleUp)",
                style = ZenobiaTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.applyScaleUp().toSp())
            )
            Text(
                text = "Text with a smaller size (applyScaleDown)",
                style = ZenobiaTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.applyScaleDown().toSp())
            )
        }
    }
}
