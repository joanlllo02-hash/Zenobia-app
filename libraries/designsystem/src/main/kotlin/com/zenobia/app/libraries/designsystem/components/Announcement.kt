    ...
    AnnouncementSurface(modifier = modifier) {
        Row {
            Icon(
                ...
                tint = if (isError) ZenobiaTheme.colors.iconCriticalPrimary else ZenobiaTheme.colors.iconPrimary,
            ...
            TitleAndDescription(
                title = title,
                description = description,
                titleColor = if (isError) ZenobiaTheme.colors.textCriticalPrimary else ZenobiaTheme.colors.textPrimary,
            )
        }
    }
}
...
private fun TitleAndDescription(
    ...
    description: String?,
    modifier: Modifier = Modifier,
    titleColor: Color = ZenobiaTheme.colors.textPrimary,
    descriptionColor: Color = ZenobiaTheme.colors.textSecondary,
...
@PreviewsDayNight
@Composable
internal fun AnnouncementPreview() = ZenobiaPreview {
    Column(
