...
fun SearchField(
    ...
    BasicTextField(
        ...
        cursorBrush = SolidColor(ZenobiaTheme.colors.textActionAccent),
    ...
    SearchFieldContainer(
        ...
        Row(modifier = Modifier.padding(start = 16.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            IconButton(onClick = onClear, enabled = showClearIcon) {
                if (showClearIcon) {
                    Icon(
                        modifier = Modifier.background(ZenobiaTheme.colors.iconSecondary, CircleShape),
...
private fun SearchFieldContainer(
    ...
    Surface(
        ...
        border = BorderStroke(
            width = 1.dp,
            color = if (isFocused) {
                ZenobiaTheme.colors.borderInteractiveHovered
            } else {
...
@Composable
internal fun SearchFieldsLightPreview() = ZenobiaPreviewLight { ContentToPreview() }

@Preview(group = PreviewGroup.Search, heightDp = 1000)
@Composable
internal fun SearchFieldsDarkPreview() = ZenobiaPreviewDark { ContentToPreview() }
