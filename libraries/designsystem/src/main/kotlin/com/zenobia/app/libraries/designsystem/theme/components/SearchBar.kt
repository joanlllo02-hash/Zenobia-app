...
object ElementSearchBarDefaults {
    ...
    fun inactiveColors() = SearchBarDefaults.colors(
        ...
        dividerColor = ZenobiaTheme.colors.borderInteractivePrimary,
        inputFieldColors = inactiveInputFieldColors(),
    )

    @Composable
    fun inactiveInputFieldColors() = TextFieldDefaults.colors(
        unfocusedPlaceholderColor = ZenobiaTheme.colors.textDisabled,
        focusedPlaceholderColor = ZenobiaTheme.colors.textDisabled,
        unfocusedTrailingIconColor = ZenobiaTheme.colors.iconDisabled,
        focusedTrailingIconColor = ZenobiaTheme.colors.iconDisabled,
    ...
    fun activeInputFieldColors() = TextFieldDefaults.colors(
        ...
        unfocusedLeadingIconColor = ZenobiaTheme.colors.iconPrimary,
        focusedLeadingIconColor = ZenobiaTheme.colors.iconPrimary,
        unfocusedTrailingIconColor = ZenobiaTheme.colors.iconTertiary,
        focusedTrailingIconColor = ZenobiaTheme.colors.iconTertiary,
...
@Composable
internal fun SearchBarInactivePreview() = ZenobiaThemedPreview { ContentToPreview() }

@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveNoneQueryPreview() = ZenobiaThemedPreview {
    ContentToPreview(
        initialQuery = "",
        active = true,
    )
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithQueryPreview() = ZenobiaThemedPreview {
    ContentToPreview(
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithQueryNoBackButtonPreview() = ZenobiaThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithNoResultsPreview() = ZenobiaThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithContentPreview() = ZenobiaThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
