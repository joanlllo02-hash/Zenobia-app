...
fun TopAppBar(
    ...
    androidx.compose.material3.TopAppBar(
        ...
        navigationIcon = navigationIcon,
        actions = {
            CompositionLocalProvider(LocalContentColor provides ZenobiaTheme.colors.textActionPrimary) {
                actions()
            }
        },
        windowInsets = windowInsets,
...
@Composable
internal fun TopAppBarPreview() = ZenobiaThemedPreview {
    TopAppBar(
...
@Preview(group = PreviewGroup.AppBars)
@Composable
internal fun TopAppBarStrPreview() = ZenobiaThemedPreview {
    TopAppBar(
