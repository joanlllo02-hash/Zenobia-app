...
package com.zenobia.app.libraries.designsystem.atomic.organisms
...
import com.zenobia.app.libraries.designsystem.atomic.molecules.InfoListItemMolecule
import com.zenobia.app.libraries.designsystem.atomic.molecules.InfoListItemPosition
...
fun InfoListOrganism(
    ...
    backgroundColor: Color = ZenobiaTheme.colors.bgSubtleSecondary,
    iconTint: Color = LocalContentColor.current,
    iconSize: Dp = 20.dp,
    textStyle: TextStyle = LocalTextStyle.current,
    textColor: Color = ZenobiaTheme.colors.textPrimary,
...
@PreviewsDayNight
@Composable
internal fun InfoListOrganismPreview() = ZenobiaPreview {
