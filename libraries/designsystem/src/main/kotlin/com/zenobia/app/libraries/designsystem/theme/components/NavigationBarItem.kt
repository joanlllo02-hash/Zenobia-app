...
object ElementNavigationBarItemDefaults {
    ...
    fun colors() = NavigationBarItemDefaults.colors().copy(
        selectedIconColor = ZenobiaTheme.colors.iconPrimary,
        selectedTextColor = ZenobiaTheme.colors.textPrimary,
        unselectedIconColor = ZenobiaTheme.colors.iconTertiary,
        unselectedTextColor = ZenobiaTheme.colors.textDisabled,
