...
fun ListItem(
    ...
    val decoratedSupportingContent: (@Composable () -> Unit)? = supportingContent?.let { content ->
        {
            CompositionLocalProvider(
                LocalTextStyle provides ZenobiaTheme.typography.fontBodyMdRegular,
...
sealed interface ListItemStyle {
    ...
    fun headlineColor() = when (this) {
        ...
        Destructive -> ZenobiaTheme.colors.textCriticalPrimary
    }
    ...
    fun supportingTextColor() = when (this) {
        ...
        Destructive -> ZenobiaTheme.colors.textCriticalPrimary.copy(alpha = 0.8f)
    }

    @Composable
    fun leadingIconColor() = when (this) {
        Default -> ListItemDefaultColors.leadingIcon
        Primary -> ZenobiaTheme.colors.iconPrimary
        Destructive -> ZenobiaTheme.colors.iconCriticalPrimary
    }
...
object ListItemDefaultColors {
    val headline: Color @Composable get() = ZenobiaTheme.colors.textPrimary
    val headlineDisabled: Color @Composable get() = ZenobiaTheme.colors.textDisabled
    val supportingText: Color @Composable get() = ZenobiaTheme.materialColors.onSurfaceVariant
    val leadingIcon: Color @Composable get() = ZenobiaTheme.colors.iconSecondary
    val trailingIcon: Color @Composable get() = ZenobiaTheme.colors.iconPrimary
    val iconDisabled: Color @Composable get() = ZenobiaTheme.colors.iconDisabled
...
private object PreviewItems {
    @Composable
    private fun EnabledDisabledZenobiaThemedPreview(
    ...
    fun ThreeLinesListItemPreview(
        ...
        EnabledDisabledZenobiaThemedPreview {
            ListItem(
