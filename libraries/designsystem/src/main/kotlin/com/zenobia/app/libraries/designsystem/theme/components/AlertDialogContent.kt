...
internal fun DialogPreview(content: @Composable () -> Unit) {
    Box(
        modifier = Modifier
            .background(ZenobiaTheme.materialColors.onSurfaceVariant)
...
internal object DialogContentDefaults {
    ...
    val containerColor: Color
        @Composable
        @ReadOnlyComposable
        get() = ZenobiaTheme.colors.bgCanvasDefault

    val textContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = ZenobiaTheme.materialColors.onSurfaceVariant

    val titleContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = ZenobiaTheme.materialColors.onSurface

    val iconContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = ZenobiaTheme.materialColors.primary
}
