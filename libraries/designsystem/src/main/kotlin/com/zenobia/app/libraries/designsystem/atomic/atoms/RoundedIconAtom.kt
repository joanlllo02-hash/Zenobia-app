...
import com.zenobia.app.libraries.designsystem.theme.temporaryColorBgSpecial
...
fun RoundedIconAtom(
    ...
    tint: Color = ZenobiaTheme.colors.iconSecondary,
    backgroundTint: Color = ZenobiaTheme.colors.temporaryColorBgSpecial,
) {
    Box(
        modifier = modifier
...
@PreviewsDayNight
@Composable
internal fun RoundedIconAtomPreview() = ZenobiaPreview {
