...
fun HeaderFooterPage(
    ...
    containerColor: Color = ZenobiaTheme.colors.bgCanvasDefault,
...
@PreviewsDayNight
@Composable
internal fun HeaderFooterPagePreview() = ZenobiaPreview {
    HeaderFooterPage(
        content = {
            Box(
...
@PreviewsDayNight
@Composable
internal fun HeaderFooterPageScrollablePreview() = ZenobiaPreview {
    HeaderFooterPage(
        content = {
            Box(
                modifier = Modifier.fillMaxWidth(),
