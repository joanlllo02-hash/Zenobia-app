...
package com.zenobia.app.libraries.push.impl.notifications.channels
...
class NotificationChannelsTest : RobolectricTest() {
    ...
    fun `recreateNoisyChannel - ElementFade uses bundled fade URI`() {
        ...
        val expected = "android.resource://${context.packageName}/${com.zenobia.app.libraries.push.impl.R.raw.element_fade}".toUri()
    ...
    fun `readNoisyChannelSound - classifies the bundled message URI as ElementDefault`() = runTest {
        val context = RuntimeEnvironment.getApplication()
        val ourBundled = "android.resource://${context.packageName}/${com.zenobia.app.libraries.push.impl.R.raw.message}".toUri()
        val channel = mockk<android.app.NotificationChannel>(relaxed = true) {
    ...
    fun `readNoisyChannelSound - classifies the bundled fade URI as ElementFade`() = runTest {
        val context = RuntimeEnvironment.getApplication()
        val ourFade = "android.resource://${context.packageName}/${com.zenobia.app.libraries.push.impl.R.raw.element_fade}".toUri()
        val channel = mockk<android.app.NotificationChannel>(relaxed = true) {
