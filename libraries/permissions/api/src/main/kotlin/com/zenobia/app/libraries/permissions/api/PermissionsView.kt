...
package com.zenobia.app.libraries.permissions.api
...
@PreviewsDayNight
@Composable
internal fun PermissionsViewPreview(@PreviewParameter(PermissionsStateProvider::class) state: PermissionsState) = ZenobiaPreview {
    PermissionsView(
        state = state,
    )
}
