...
@Composable
internal fun IconsCompoundPreviewLight() = ZenobiaTheme {
    IconsCompoundPreview()
}

@Preview(widthDp = 730, heightDp = 1920)
@Composable
internal fun IconsCompoundPreviewRtl() = ZenobiaTheme {
...
@Preview(widthDp = 730, heightDp = 1920)
@Composable
internal fun IconsCompoundPreviewDark() = ZenobiaTheme(theme = Theme.Dark) {
    IconsCompoundPreview()
}
