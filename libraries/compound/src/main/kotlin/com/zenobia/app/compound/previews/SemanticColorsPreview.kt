...
package com.zenobia.app.compound.previews
...
@Composable
internal fun CompoundSemanticColorsLight() = ZenobiaTheme {
    Surface {
        Column(
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsLightHc() = ZenobiaTheme(
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsDark() = ZenobiaTheme(theme = Theme.Dark) {
    Surface {
        Column(
            modifier = Modifier.padding(16.dp),
            verticalArrangement = Arrangement.spacedBy(10.dp)
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsDarkHc() = ZenobiaTheme(
    theme = Theme.Dark,
    compoundDark = compoundColorsHcDark,
) {
    Surface {
...
private fun getSemanticColors(): ImmutableMap<String, Color> {
    return with(ZenobiaTheme.colors) {
        persistentMapOf(
