        ...
        reports {
            filters {
                excludes {
                    classes(
                        ...
                        "com.zenobia.app.libraries.designsystem.showkase.*",
                        ...
                        "*Presenter\$present\$*",
                        // Forked from compose
                        "com.zenobia.app.libraries.designsystem.theme.components.bottomsheet.*",
                        // Konsist code to make test fails
                        "com.zenobia.app.tests.konsist.failures",
                        // Copied from Appyx
                        "com.zenobia.app.libraries.architecture.appyx.SafeChildrenTransitionScope",
                        // DI-generated classes
                        "com.zenobia.app.di.*Impl",
                        "com.zenobia.app.di.*Impls",
                        "com.zenobia.app.di.*Mirror",
                        "com.zenobia.app.di.*Factory",
                        $$"com.zenobia.app.*$Metro*",
                        $$"com.zenobia.app.*$Factory*",
                        $$"com.zenobia.app.*$Impl*",
                    )
                    annotatedBy(
                        "androidx.compose.ui.tooling.preview.Preview",
                        "com.zenobia.app.libraries.architecture.coverage.ExcludeFromCoverage",
                        "com.zenobia.app.libraries.designsystem.preview.*",
                    )
                }
            }
            ...
            variant(KoverVariant.Presenters.variantName) {
                ...
                filters {
                    excludes.classes(
                        "*Fake*Presenter*",
                        "com.zenobia.app.appnav.loggedin.LoggedInPresenter$*",
                        // Some options can't be tested at the moment
                        "com.zenobia.app.features.preferences.impl.developer.DeveloperSettingsPresenter$*",
                        // Need an Activity to use rememberMultiplePermissionsState
                        "com.zenobia.app.features.location.impl.common.permissions.DefaultPermissionsPresenter",
                        "*Presenter\$present\$*",
                        // Too small to be > 85% tested
                        "com.zenobia.app.libraries.fullscreenintent.impl.DefaultFullScreenIntentPermissionsPresenter",
                    )
                    includes.inheritedFrom("com.zenobia.app.libraries.architecture.Presenter")
                }
            }
            variant(KoverVariant.States.variantName) {
                ...
                filters {
                    excludes.classes(
                        ...
                        "com.zenobia.app.appnav.root.RootNavState",
                        "com.zenobia.app.features.ftue.api.state.*",
                        "com.zenobia.app.features.ftue.impl.welcome.state.*",
                        "com.zenobia.app.features.messages.impl.timeline.model.bubble.BubbleState",
                        "com.zenobia.app.libraries.designsystem.swipe.SwipeableActionsState",
                        "com.zenobia.app.libraries.designsystem.theme.components.bottomsheet.CustomSheetState",
                        "com.zenobia.app.libraries.maplibre.compose.CameraPositionState",
                        "com.zenobia.app.libraries.maplibre.compose.SymbolState",
                        "com.zenobia.app.libraries.matrix.api.room.RoomMembershipState",
                        "com.zenobia.app.libraries.matrix.api.room.RoomMembersState",
                        "com.zenobia.app.libraries.matrix.api.timeline.item.event.OtherState$*",
                        "com.zenobia.app.libraries.matrix.api.timeline.item.event.LocalEventSendState*",
                        "com.zenobia.app.libraries.mediaviewer.impl.local.pdf.PdfViewerState",
                        "com.zenobia.app.libraries.mediaviewer.impl.local.player.MediaPlayerControllerState",
                        "com.zenobia.app.libraries.textcomposer.model.TextEditorState",
                        "com.zenobia.app.libraries.textcomposer.components.FormattingOptionState",
                    )
